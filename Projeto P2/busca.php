...
<head>
    ...
    <title>Mitsuki Store | Busca</title>
</head>

<body id="corpo" onload="get_busca();">
    <header id="cabecario">
    ...
    <section class="colecao" id="pag-busca">
        <div class="container py-5">
            <div class="row py-5">
                <div class="m-auto">
                    <h1 id="titulo">Pesquisou por: </h1><h2 id="produto-procurado"></h2>
                </div>
            </div>
            <div class="row">
    ...
    <section class="contato py-5" id="contato">
        <div class="container py-5">
            <div class="row">
                <div class="col-lg-5 m-auto text-center">
                    <h1 id="titulo">Não encontrou o que procurava?</h1>
                    <h6 style="color: red;">Entre em contato e peça já o seu Amigurumi personalizado!</h6>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-9">
