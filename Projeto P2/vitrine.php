...
<head>
    ...
    <title>Mitsuki Store | Produtos</title>
</head>
        ...
        <div class="container py-5">
            <div class="row py-5">
                <div class="col-lg-5 m-auto text-center">
                    ...
                    <h6 style="color: red;">Adquira já seu amigurumi favorito!</h6>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-6 text-center m-auto">
                    <button class="btn1" id="botao-vitrine">EM BREVE MAIS PRODUTOS!</button>
                </div>
            </div>
        </div>
    </section>
